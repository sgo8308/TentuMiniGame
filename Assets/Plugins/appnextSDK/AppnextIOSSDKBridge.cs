...
namespace appnext
{
	public class AppnextIOSSDKBridge : MonoBehaviour
	{
        ...
        [DllImport("__Internal")]
        private static extern int appnextGetConfigDefaultInt(string configParamName);
        ...
        [DllImport("__Internal")]
        private static extern string appnextCreateBanner(string placementID);

		[DllImport ("__Internal")]
		private static extern bool appnextDisposeBanner(string adKey);

		[DllImport ("__Internal")]
		private static extern void appnextLoadBanner(string adKey, string jsonRequest);
		...
		/// allback Methods - Banners Callbacks

		[DllImport ("__Internal")]
		private static extern void appnextSetOnBannerLoadedCallback(string adKey, string gameObject, string method);
		
		[DllImport ("__Internal")]
		private static extern void appnextSetOnBannerErrorCallback(string adKey, string gameObject, string method);
		
		[DllImport ("__Internal")]
		private static extern void appnextSetOnBannerClickedCallback(string adKey, string gameObject, string method);
		
		[DllImport ("__Internal")]
		private static extern void appnextsetOnBannerImpressionReportedCallback(string adKey, string gameObject, string method);
        ...
        public static int getConfigDefaultInt(string configParamName)
        {
            return appnextGetConfigDefaultInt(configParamName);
        }
		...
		// Public Bridge Methods - Banners
		public static string createBanner(string placementID) {
			return appnextCreateBanner(placementID);
		}

		public static void disposeBanner(string adKey) {
			appnextDisposeBanner(adKey);
		}

		public static void loadBanner(string adKey, string jsonRequest) {
			appnextLoadBanner(adKey, jsonRequest);
		}

		// Public Bridge Methods - Banners Callbacks

		public static void setOnBannerLoadedCallback(string adKey, string gameObject, string method) {
			appnextSetOnBannerLoadedCallback(adKey, gameObject, method);
		}

		public static void setOnBannerErrorCallback(string adKey, string gameObject, string method) {
			appnextSetOnBannerErrorCallback(adKey, gameObject, method);
		}

		public static void setOnBannerClickedCallback(string adKey, string gameObject, string method) {
			appnextSetOnBannerClickedCallback(adKey, gameObject, method);
		}

		public static void setOnBannerImpressionReportedCallback(string adKey, string gameObject, string method) {
			appnextsetOnBannerImpressionReportedCallback(adKey, gameObject, method);
		}
