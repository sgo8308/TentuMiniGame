...
#endif
{
    ...
    int appnextGetConfigDefaultInt(const char* configParamName);
    double appnextGetConfigDefaultDouble(const char* configParamName);
    
    
    // Banner Managment Methods
    const char* appnextCreateBanner(const char* placementID);
    void appnextDisposeBanner(const char* adKey);
    void appnextLoadBanner(const char* adKey, const char* jsonRequest);
    
    // Banner Callbacks
    
    void appnextSetOnBannerLoadedCallback(const char* adKey, const char* gameObject, const char* method);
    void appnextSetOnBannerErrorCallback(const char* adKey, const char* gameObject, const char* method);
    void appnextSetOnBannerClickedCallback(const char* adKey, const char* gameObject, const char* method);
    void appnextsetOnBannerImpressionReportedCallback(const char* adKey, const char* gameObject, const char* method);
    ...
    // Interstitial Ad Setters/Getters Methods
