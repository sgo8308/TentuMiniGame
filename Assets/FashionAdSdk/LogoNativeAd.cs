...
public class LogoNativeAd : MonoBehaviour
{
    ...
    public void ShowAd()
    {
        string url = "https://global.appnext.com/offerWallApi.aspx?tid=API&did=03382e13-716f-47c0-8b40-10ca1ad1abe1&id=99dd343b-c93a-418f-b393-19f968a387f3&ip=92.38.148.61&lockcat=Shopping&uagent=Dalvik%2f2.1.0+(Linux%3b+U%3b+Android+9%3b+Redmi+Note+7+Pro+MIUI%2fV10.3.9.0.PFHINXM)";
    ...
    IEnumerator ShowAdChain(string url,string userId, System.Action<FashionAdApi.NativeAdData> var)
    {
        ...
        StartCoroutine(fApi.sendShowAd(panelAdData.apps[0].urlImg));//광고 정보 갖고오면 이미지url넣어서 보여준다.
